...
TEST_CASE("Scanning SingleLine.txt forwards creates the right predecessors/", "[part=landmark]") {
    ...
    std::unordered_map<Vertex, Vertex> result = lpath.getPred();
...
TEST_CASE("The source, landmark, and destination are all the same point/", "[part=landmark]") {
    /* G visual:
    ...
    */
    ...
    Landmark lpath(G, "Dragonfruit");
    lpath.store_path("Dragonfruit", "Dragonfruit", "Dragonfruit");
    std::vector<Vertex> result = lpath.getPath();
...
TEST_CASE("Source is the same as destination/", "[part=landmark]") {
    /* G visual:
    ...
    */
    ...
    G.insertEdge("Apple", "Dragonfruit");
    G.insertEdge("Banana", "Carrot");
    G.insertEdge("Dragonfruit", "Carrot");

    Landmark lpath(G, "Carrot");
    lpath.store_path("Apple", "Carrot", "Apple");
    std::vector<Vertex> result = lpath.getPath();

    std::vector<Vertex> ansLine = {"Apple", "Dragonfruit", "Carrot", "Dragonfruit", "Apple"};
